<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="BusquedaArchivos.aspx.cs" Inherits="Manteca_Box_develop.Formulario_web11" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="demo-card-wide mdl-card mdl-shadow--2dp">
        <div class="mdl-card__title">
            <h1 class="mdl-card__title-text">Búsqueda de archivos</h1>
        </div>
        <asp:GridView ID="GridViewBusqueda" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridViewBusqueda_RowDataBound" CssClass="mdl-data-table mdl-js-data-table mdl-shadow--2dp listado-archivos">
            <Columns>
                <asp:TemplateField >
                    <ItemTemplate>
